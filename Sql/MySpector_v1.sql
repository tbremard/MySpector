...
CREATE TABLE IF NOT EXISTS `MYSPECTOR`.`WEB_TARGET_TYPE` (
  ...
  PRIMARY KEY (`ID_WEB_TARGET_TYPE`, `NAME`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `MYSPECTOR`.`XTRAX_TYPE` (
  ...
  `NAME` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`ID_XTRAX_TYPE`, `NAME`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `MYSPECTOR`.`CHECKER_TYPE` (
  ...
  `NAME` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`ID_CHECKER_TYPE`, `NAME`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `MYSPECTOR`.`NOTIFY_TYPE` (
  ...
  `NAME` VARCHAR(50) NOT NULL,
  PRIMARY KEY (`ID_NOTIFY_TYPE`, `NAME`))
ENGINE = InnoDB;
